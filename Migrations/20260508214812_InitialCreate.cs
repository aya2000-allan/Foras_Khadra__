    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ManualOrganizations", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeadlineType = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "كل دول العالم", "All World", "Tous les pays du monde" },
                    { 2, "الوطن العربي ", "The Arab World", "Le Monde arabe" },
                    { 3, "فلسطين", "Palestine", "Palestine" },
                    { 4, "الأردن", "Jordan", "Jordanie" },
                    { 5, "سوريا", "Syria", "Syrie" },
                    { 6, "لبنان", "Lebanon", "Liban" },
                    { 7, "العراق", "Iraq", "Irak" },
                    { 8, "السعودية", "Saudi Arabia", "Arabie saoudite" },
                    { 9, "الكويت", "Kuwait", "Koweït" },
                    { 10, "قطر", "Qatar", "Qatar" },
                    { 11, "البحرين", "Bahrain", "Bahreïn" },
                    { 12, "الإمارات العربية المتحدة", "United Arab Emirates", "Émirats arabes unis" },
                    { 13, "عُمان", "Oman", "Oman" },
                    { 14, "اليمن", "Yemen", "Yémen" },
                    { 15, "مصر", "Egypt", "Égypte" },
                    { 16, "السودان", "Sudan", "Soudan" },
                    { 17, "ليبيا", "Libya", "Libye" },
                    { 18, "تونس", "Tunisia", "Tunisie" },
                    { 19, "الجزائر", "Algeria", "Algérie" },
                    { 20, "المغرب", "Morocco", "Maroc" },
                    { 21, "موريتانيا", "Mauritania", "Mauritanie" },
                    { 22, "جيبوتي", "Djibouti", "Djibouti" },
                    { 23, "الصومال", "Somalia", "Somalie" },
                    { 24, "جزر القمر", "Comoros", "Comores" }
                });
